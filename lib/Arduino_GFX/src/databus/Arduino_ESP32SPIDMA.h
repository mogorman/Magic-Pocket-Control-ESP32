...
// esp_memory_utils.h only exists on ESP-IDF 5.x (arduino-esp32 core 3.x).
// This SPIDMA databus is not used by this project (the CO5300 panel is driven
// over QSPI), so guard the include to keep older cores compiling.
